...
* Move .gbackup file to Internal Storage > Galileo_backups folder. All .gbackup files from this directory will be listed in Galileo. Go to Settings > Data Backup and tap prefered backup.
