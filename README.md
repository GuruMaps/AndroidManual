...
If you use more than one iOS/Android device, Guru Maps app will securely [sync all your data across multiple devices](03-settings.md#sync) and there is also a [backup feature](03-settings.md#dataBackup) to make a copy of your information.
