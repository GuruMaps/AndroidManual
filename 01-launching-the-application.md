...
If you use Galileo feature, that requires permission to read/write on your device storage \(Such as [Data backup](03-settings.md#dataBackup)\), you will see a message asking you to enable it.
